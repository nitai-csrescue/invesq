  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        animate={{
          scale: phase >= 5 ? 1.3 : phase >= 3 ? 1.3 : 1,
          x: phase >= 5 ? '-15vw' : phase >= 3 ? '15vw' : 0,
          y: phase >= 5 ? '5vh' : phase >= 3 ? '-10vh' : 0,
          opacity: 1
        }}
        transition={{ type: 'spring', stiffness: 80, damping: 20 }}
      >
        <img src={engagementImg} className="w-full h-full object-cover object-left-top" alt="Value Creation Opportunities" />
      </motion.div>
      ...
      <Cursor 
        ...
        label={
          phase >= 5 ? "Retention Improvements" :
          phase >= 3 ? "Upsell Potential" : 
