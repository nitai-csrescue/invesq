...
export const integrations: Integration[] = [
  {
    ...
    whyItMatters: "Salesforce is the system of record for accounts and renewals. CS Rescue reads ownership and renewal data to route signals and actions.",
    iconLetter: "S",
  ...
  },
  {
    ...
    whyItMatters: "Migrate health/touchpoint history when customers replace Gainsight with CS Rescue.",
    iconLetter: "G",
  ...
  },
  {
    ...
    whyItMatters: "CS Rescue posts at-risk alerts and expansion briefings into the right team channels.",
    iconLetter: "S",
  ...
  },
  {
    ...
    whyItMatters: "When customers have a warehouse-first stack, CS Rescue can read directly from modeled tables.",
    iconLetter: "S",
  ...
  },
  {
    ...
    whyItMatters: "Behavioral cohorts let CS Rescue benchmark each account against peers.",
    iconLetter: "A",
